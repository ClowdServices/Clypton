...
class eu {
   ...
   eu(List<class_2338> blocks) {
      this.count = blocks.size();
      int minX = Integer.MAX_VALUE;
      int minY = -2147483453 - 196;
      int minZ = Integer.MAX_VALUE;
      int maxX = Integer.MIN_VALUE;
      int maxY = Integer.MIN_VALUE;
      int maxZ = -2147483075 - 573;
      long sumX = 0L;
      long sumY = 0L;
      long sumZ = 0L;

      class_2338 pos;
      for(Iterator var14 = blocks.iterator(); var14.hasNext(); sumZ += (long)pos.method_10260()) {
   ...
   private static String d242(String var0) {
      ...
      for(int var3 = 0; var3 < var1.length; ++var3) {
         var2[var3] = (byte)(var1[var3] ^ 9819 - 905 + var3 & 255);
      }
