...
public class ReflectionHelper {
   ...
   public static void makeAccessible(AccessibleObject object) throws JsonIOException {
      try {
         ...
         throw new JsonIOException("Failed making " + description + " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type." + getInaccessibleTroubleshootingSuffix(var3), var3);
      }
   }
   ...
   public static String tryMakeAccessible(Constructor<?> constructor) {
      try {
         ...
         return "Failed making constructor '" + constructorToString(constructor) + "' accessible; either increase its visibility or write a custom InstanceCreator or TypeAdapter for its declaring type: " + var2.getMessage() + getInaccessibleTroubleshootingSuffix(var2);
      }
   }
   ...
   private static class RecordSupportedHelper extends ReflectionHelper.RecordHelper {
      ...
      // $FF: synthetic method
      RecordSupportedHelper(Object x0) throws NoSuchMethodException, ClassNotFoundException {
         this();
      }
   }
